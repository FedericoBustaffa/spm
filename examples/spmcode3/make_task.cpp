...
template <typename Func,	// <-- type of the func
		  typename... Args, // <-- arguments type arg0, arg1, ...
		  typename Rtrn = typename std::result_of<
			  Func(Args...)>::type> // ^-- type of the return value func(args)
...
bool comp(float value, int64_t threshold) { return value < threshold; }
