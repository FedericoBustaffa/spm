...
void gfx_open(int width, int height, const char *title)
{
	...
	{ // MODIFIED: c_class instead of class to compile the file with a C++ compiler
...
void gfx_draw_row(int y, int *row, int width)
{
	...
	XImage *image = XCreateImage(gfx_display, DefaultVisual(gfx_display, 0),
								 24, // 24-bit depth
								 ZPixmap, 0, data, width,
								 1,	 // one row
